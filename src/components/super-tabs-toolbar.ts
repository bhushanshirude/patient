...
import { SuperTabsPanGesture } from '../ionic2-super-tabs/super-tabs-pan-gesture';
...
export class SuperTabsToolbar implements AfterViewInit, OnDestroy {
  ...
  public tabButtons: QueryList<SuperTabButton>;

  @ViewChild('tabButtonsContainer')
  public tabButtonsContainer: ElementRef;

  @ViewChild('indicator')
  public indicator: ElementRef;

  @ViewChild('tabButtons')
  public tabButtonsBar: ElementRef;
  ...
  public gesture: SuperTabsPanGesture;
   ...
   * @param animate
   */
  public toggleAnimation(el: 'indicator' | 'segment', animate: boolean) {
